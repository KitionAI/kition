...
function isEditableWorkspaceDocument(relativePath) {
  return /\.(md|markdown|kitable)$/i.test(String(relativePath || ''))
}

function isTextWorkspaceDocument(relativePath) {
  return /\.(md|markdown|txt|csv|tsv|json|html|htm)$/i.test(String(relativePath || ''))
}

function isSupportedWorkspaceDocument(relativePath) {
  return /\.(md|markdown|kitable|txt|csv|tsv|json|html|htm|pdf|docx|xlsx|xls|pptx|ppt|png|jpe?g|gif|webp|svg|mp4|mov|webm|mp3|wav|m4a)$/i.test(String(relativePath || ''))
}
