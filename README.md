...
<p align="center">
  <strong>Documents, structured data, AI research, and automation in one desktop workspace.</strong><br />
  Write connected knowledge, build data tools, research in the browser, and automate repeatable work.
</p>

<p align="center">
  <a href="https://github.com/KitionAI/kition/stargazers"><img src="https://img.shields.io/github/stars/KitionAI/kition?style=flat&label=stars" alt="GitHub stars" /></a>
  <a href="https://github.com/KitionAI/kition/actions/workflows/ci.yml"><img src="https://github.com/KitionAI/kition/actions/workflows/ci.yml/badge.svg" alt="CI" /></a>
  <a href="https://github.com/KitionAI/kition/releases"><img src="https://img.shields.io/github/v/release/KitionAI/kition?display_name=tag&sort=semver" alt="Latest release" /></a>
  <a href="LICENSE"><img src="https://img.shields.io/badge/license-AGPL--3.0--only-5645d4" alt="License: AGPL-3.0-only" /></a>
  <img src="https://img.shields.io/badge/status-beta-f5d75e" alt="Project status: beta" />
  <img src="https://img.shields.io/badge/macOS%20%7C%20Windows-supported-5645d4" alt="Supported platforms: macOS and Windows" />
</p>
