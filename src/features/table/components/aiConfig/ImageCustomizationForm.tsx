...
export function ImageCustomizationForm({
  fields,
  currentFieldId,
  value,
  onChange,
  ...
  value: ImageCustomizationConfig
  onChange: (next: ImageCustomizationConfig) => void
}) {
  const { t } = useTranslation('table')
  function patch(partial: Partial<ImageCustomizationConfig>) {
  ...
  return (
    <div className="data-inline-ai-config-form">
      ...
      <label>
        <span>{t('aiConfig.sourceImageField')}</span>
        <SourceFieldPicker
          fields={fields}
          currentFieldId={currentFieldId}
          value={value.source_field_id ?? null}
