...
describe('DocumentTemplateLibraryDialog', () => {
  it('shows a blank document and the built-in template library', async () => {
    ...
    expect(document.querySelector('[data-testid="document-template-flowchart"]')?.getAttribute('data-cover-image')).toBe('kition-bundled:/templates/document-covers/flowchart.webp')
