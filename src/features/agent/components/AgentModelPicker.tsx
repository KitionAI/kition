      ...
      <Popover open={open} onOpenChange={setOpen}>
        <PopoverTrigger asChild>
          {variant === 'compact' ? (
            <button
              ...
              className={cn(
                'flex h-8 min-w-0 max-w-full items-center gap-1 rounded-lg px-1.5 text-left text-xs font-medium text-muted-foreground transition-colors',
              ...
              title={selectedOption ? selectedModelLabel(selectedOption) : resolvedEmptyLabel}
            >
              <span className="truncate">
                {selectedOption ? selectedOption.modelName : resolvedEmptyLabel}
              </span>
        ...
        {open ? (
          <PopoverContent
            ...
            aria-label={resolvedAriaLabel}
            className={cn(
              'agent-composer-popover flex max-h-[var(--radix-popover-content-available-height)] flex-col overflow-hidden rounded-xl p-0',
              variant === 'compact' ? 'w-[280px]' : 'w-[var(--radix-popover-trigger-width)]',
            )}
          >
            ...
            <div role="listbox" aria-label={resolvedAriaLabel} className="min-h-0 max-h-80 overflow-y-auto p-2">
